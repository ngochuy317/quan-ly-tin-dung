        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("admin", "Admin"), ("employee", "Nhân viên"), ("collaborators", "Cộng tác viên")],
                        max_length=127,
                    ),
                ),
                ...
                (
                    "infomation_detail",
                    models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to="user.infomationdetail"),
                ),
